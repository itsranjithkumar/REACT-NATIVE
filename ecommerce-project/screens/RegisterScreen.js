                ...
                <KeyboardAvoidingView>
                    ...
                    <View  
                      ...
                      <Ionicons name="person" size={24} color="gray" style = {{marginLeft:8}}/>
                        <TextInput value={name} onChangeText={(text) => setName(text)}  style={{color:"gray",marginVertical:10,width:300,fontsize: password ? 16 : 16}} placeholder="enter your name"/>
                        ...
                        <TextInput value={email} onChangeText={(text) => setEmail(text)}  style={{color:"gray",marginVertical:10,width:300,fontsize: password ? 16 : 16}} placeholder="enter your Email"/>
                     ...
                     <AntDesign name="lock1" size={24} color="gray" style = {{marginLeft:8}}/>
                      ...
                      secureTextEntry={true} style={{color:"gray",marginVertical:10,width:300,fontSize:email ? 16 : 16}} placeholder="enter your Password"/>
