...
const AddressScreen = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      console.log("aaaaaaaaaa", decodedToken)
  ...
  const handleAddAddress = () => {
    ...
    axios.post("http://192.168.146.194:8000/addresses", { userId, address }).then((response) => {
    ...
    <ScrollView style={{ marginTop: 50 }}>
      ...
      <View style={{ padding: 10 }}>
        ...
        <Pressable
          ...
          style={{ backgroundColor: "#FFC72C", padding: 15, borderRadius: 6, justifyContent: "center", alignItems: "center", marginTop: 20 }}>
