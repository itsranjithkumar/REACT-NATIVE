...
import { incemetQuantity } from "../redux/CartReducer";
...
const CartScreen = () => {
  ...
  const increaseQuantity = (item) => (
    ...
    return (
      ...
      <Text style={{ marginHorizontal: 18 }}>EMI details Available</Text>
                    ...
                    <View
                        ...
                        <Pressable style={{marginTop:15, marginBottom:10,flexDirection:"row",alignItems:"center",gap:10}}>
                         <View style={{flexDirection:"row",alignItems:"center",paddingHorizontal:10,paddingVertical:5,borderRadius:7}}>
                             <Pressable style ={{backgroundColor:"#D0D0D0",padding:7,borderTopLeftRadius:6,borderBottomLeftRadius:6}}> 
                        ...
                        <Pressable style={{backgroundColor:"white",paddingHorizontal:8,paddingVertical:18,borderRadius:5,borderColor:"#C0C0C0",borderWidth:0.6}}>
