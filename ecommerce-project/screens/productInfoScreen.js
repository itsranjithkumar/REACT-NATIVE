import { StyleSheet, View, Text, ScrollView, Pressable, TextInput, ImageBackground, Dimensions, } from 'react-native'
    ...
    return (
        <ScrollView style={{ marginTop: 45, flex: 1, backgroundColor: "white" }} showsVerticalScrollIndicator={false}>
                ...
                {route.params.carouselImages.map((item, index) => (
                    ...
                    <ImageBackground style={{ width, height, marginTop: 25, resizeMode: "contain" }} source={{ uri: item }} Key={index}>
                        <View style={{ padding: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                            <View style={{
                                width: 40, height: 40, borderRadius: 20, backgroundColor: "#C60C30", justifyContent: "center", alignItems
                            ...
                            <View style={{
                                width: 40, height: 40, borderRadius: 20, backgroundColor: "#E0E0E0", justifyContent: "center", alignItems
                                    : "center", flexDirection: "row"
                            }}>
                        ...
                        <View style={{
                                width: 40, height: 40, borderRadius: 20, backgroundColor: "#E0E0E0", justifyContent: "center", alignItems
                                    : "center", flexDirection: "row",marginTop:"auto",marginLeft:20,marginBottom:20
                            }}>
            ...
            <View style={{padding:10}}>
                     ...
                     <Text style={{fontSize:15,fontWeight:"500"}}>Deliver To Ranjith - Bangalore 560019</Text>
                     </View>
            </View>

           <Text style={{color:"green",marginHorizontal:10,fontWeight:"500"}}>IN Stock</Text>

           <Pressable style={{backgroundColor:"#FFC72C",padding:18,borderRadius:20,justifyConent:"center",alignItems:"center",marginHorizontal:10,marginVertical:14}}> 
               <Text>Add to Cart</Text>
           </Pressable>

           <Pressable style={{backgroundColor:"#FFAC1C",padding:18,borderRadius:20,justifyConent:"center",alignItems:"center",marginHorizontal:10,marginVertical:14}}> 
               <Text>Buy Now</Text>
           </Pressable>
        </ScrollView>
    );
